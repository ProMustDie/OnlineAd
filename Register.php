...
<body class="bg-light">
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center mb-5" id="register">
            ...
            <div class="login" id="register">
                <form action="#" method="POST" class="needs-validation container" novalidate>
                    ...
                    <div class="d-flex flex-column mx-auto w-75">
                        ...
                        <a href="forgot.php" class="mb-2 ms-auto fw-semibold">Forgot Password?</a>
                    </div>
